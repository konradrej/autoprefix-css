 ...
 * @returns
 */
export async function* fetchFilesFromDirectory(directory: fs.PathLike, extension?: string): AsyncGenerator<string> {
  const dirents: fs.Dirent[] = await fs.promises.readdir(directory, { withFileTypes: true })
